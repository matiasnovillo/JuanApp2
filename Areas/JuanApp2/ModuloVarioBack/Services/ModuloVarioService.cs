...
namespace JuanApp2.Areas.JuanApp2.ModuloVarioBack.Services
{
    public class ModuloVarioService : IModuloVarioService
    {
        #region Exportations
        public void ExportToExcel(string path, DataTable dtModuloVario)
        {
            using var Book = new XLWorkbook();

            DataTable dtModuloVarioOriginal = new()
            {
                TableName = "ModuloVario"
            };

            //We define another DataTable dtModuloVarioCopy to avoid issue related to DateTime conversion
            DataTable dtModuloVarioCopy = new()
            {
                TableName = "ModuloVario"
            };

            #region Define columns for dtModuloVarioCopy
            DataColumn dtColumnModuloVarioIdFordtModuloVarioCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "ModuloVarioId"
            };
            dtModuloVarioCopy.Columns.Add(dtColumnModuloVarioIdFordtModuloVarioCopy);

            DataColumn dtColumnActiveFordtModuloVarioCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "Active"
            };
            dtModuloVarioCopy.Columns.Add(dtColumnActiveFordtModuloVarioCopy);

            DataColumn dtColumnDateTimeCreationFordtModuloVarioCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "DateTimeCreation"
            };
            dtModuloVarioCopy.Columns.Add(dtColumnDateTimeCreationFordtModuloVarioCopy);

            DataColumn dtColumnDateTimeLastModificationFordtModuloVarioCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "DateTimeLastModification"
            };
            dtModuloVarioCopy.Columns.Add(dtColumnDateTimeLastModificationFordtModuloVarioCopy);

            DataColumn dtColumnUserCreationIdFordtModuloVarioCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "UserCreationId"
            };
            dtModuloVarioCopy.Columns.Add(dtColumnUserCreationIdFordtModuloVarioCopy);

            DataColumn dtColumnUserLastModificationIdFordtModuloVarioCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "UserLastModificationId"
            };
            dtModuloVarioCopy.Columns.Add(dtColumnUserLastModificationIdFordtModuloVarioCopy);

            DataColumn dtColumnFechaFordtModuloVarioCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "Fecha"
            };
            dtModuloVarioCopy.Columns.Add(dtColumnFechaFordtModuloVarioCopy);

            DataColumn dtColumnDescripcionFordtModuloVarioCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "Descripcion"
            };
            dtModuloVarioCopy.Columns.Add(dtColumnDescripcionFordtModuloVarioCopy);

            DataColumn dtColumnDineroEfectivoFordtModuloVarioCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "DineroEfectivo"
            };
            dtModuloVarioCopy.Columns.Add(dtColumnDineroEfectivoFordtModuloVarioCopy);

            DataColumn dtColumnDineroBancoFordtModuloVarioCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "DineroBanco"
            };
            dtModuloVarioCopy.Columns.Add(dtColumnDineroBancoFordtModuloVarioCopy);

            DataColumn dtColumnDineroChequeFordtModuloVarioCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "DineroCheque"
            };
            dtModuloVarioCopy.Columns.Add(dtColumnDineroChequeFordtModuloVarioCopy);

            DataColumn dtColumnDineroTotalFordtModuloVarioCopy = new()
            {
                DataType = typeof(string),
            ...
            dtModuloVarioOriginal = dtModuloVario;

            foreach (DataRow DataRow in dtModuloVarioOriginal.Rows)
            {
                dtModuloVarioCopy.Rows.Add(DataRow.ItemArray);
            }

            var Sheet = Book.Worksheets.Add(dtModuloVarioCopy);
        ...
        public void ExportToCSV(string path, List<ModuloVario> lstModuloVario)
        {
            using var Writer = new StreamWriter(path);

            using var CsvWriter = new CsvWriter(Writer, CultureInfo.InvariantCulture);

            CsvWriter.WriteRecords(lstModuloVario);
        }

        public void ExportToPDF(string path, List<ModuloVario> lstModuloVario)
        {
            string ProjectName = "EmptyProject";
            string Table = "ModuloVario";
            ...
            {
                RowsAsHTML += $@"{ModuloVario?.ToStringOnlyValuesForHTML()}";
            }
    ...
    <tr>
        <th align=""left"" valign=""top"" style=""border-width: 1px; border-style: solid; border-color: #e8e8e8; border-top: none; border-left: none; border-right: none;"">
            <font face=""'Source Sans Pro', sans-serif"" color=""#000000"" style=""font-size: 20px; line-height: 28px; font-weight: 600;"">
                <span style=""font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 20px; line-height: 28px; font-weight: 600;"">ModuloVarioId&nbsp;&nbsp;&nbsp;</span>
            </font>
            ...
            <font face=""'Source Sans Pro', sans-serif"" color=""#000000"" style=""font-size: 20px; line-height: 28px; font-weight: 600;"">
                <span style=""font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 20px; line-height: 28px; font-weight: 600;"">ModuloVarioStatusId&nbsp;&nbsp;&nbsp;</span>
            </font>
            <div style=""height: 10px; line-height: 10px; font-size: 8px;"">&nbsp;</div>
        </th>
    </tr>
...
").SaveAs(path);
        ...
        #region Importations
        public List<ModuloVario> ImportExcel(string path, int userId)
        {
            ...
            foreach (var row in Rows)
            {
                ...
                if (rowNumber > 1)
                {
                    ...
                    string Descripcion = row.Cell(8).GetString();
                    decimal DineroEfectivo = Convert.ToDecimal(row.Cell(9).GetString());
