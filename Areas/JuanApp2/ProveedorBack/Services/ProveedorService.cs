...
namespace JuanApp2.Areas.JuanApp2.ProveedorBack.Services
{
    public class ProveedorService : IProveedorService
    {
        ...
        public void ExportToCSV(string path, List<Proveedor> lstProveedor)
        {
            using var Writer = new StreamWriter(path);

            using var CsvWriter = new CsvWriter(Writer, CultureInfo.InvariantCulture);

            CsvWriter.WriteRecords(lstProveedor);
        }

        public void ExportToPDF(string path, List<Proveedor> lstProveedor)
        {
            ...
            {
                RowsAsHTML += $@"{Proveedor?.ToStringOnlyValuesForHTML()}";
            }
    ...
    <tr>
        <th align=""left"" valign=""top"" style=""border-width: 1px; border-style: solid; border-color: #e8e8e8; border-top: none; border-left: none; border-right: none;"">
            <font face=""'Source Sans Pro', sans-serif"" color=""#000000"" style=""font-size: 20px; line-height: 28px; font-weight: 600;"">
                <span style=""font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 20px; line-height: 28px; font-weight: 600;"">ProveedorId&nbsp;&nbsp;&nbsp;</span>
            </font>
            ...
            <font face=""'Source Sans Pro', sans-serif"" color=""#000000"" style=""font-size: 20px; line-height: 28px; font-weight: 600;"">
                <span style=""font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 20px; line-height: 28px; font-weight: 600;"">ProveedorStatusId&nbsp;&nbsp;&nbsp;</span>
            </font>
            <div style=""height: 10px; line-height: 10px; font-size: 8px;"">&nbsp;</div>
        </th>
    </tr>
...
").SaveAs(path);
        ...
        #region Importations
        public List<Proveedor> ImportExcel(string path, int userId)
        {
            ...
            foreach (var row in Rows)
            {
                ...
                if (rowNumber > 1)
                {
                    ...
                    string PaginaWeb = row.Cell(10).GetString();
