...
namespace JuanApp2.Areas.JuanApp2.CobradorBack.Services
{
    public class CobradorService : ICobradorService
    {
        #region Exportations
        public void ExportToExcel(string path, DataTable dtCobrador)
        {
            using var Book = new XLWorkbook();

            DataTable dtCobradorOriginal = new()
            {
                TableName = "Cobrador"
            };

            //We define another DataTable dtCobradorCopy to avoid issue related to DateTime conversion
            DataTable dtCobradorCopy = new()
            {
                TableName = "Cobrador"
            };

            #region Define columns for dtCobradorCopy
            DataColumn dtColumnCobradorIdFordtCobradorCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "CobradorId"
            };
            dtCobradorCopy.Columns.Add(dtColumnCobradorIdFordtCobradorCopy);

            DataColumn dtColumnActiveFordtCobradorCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "Active"
            };
            dtCobradorCopy.Columns.Add(dtColumnActiveFordtCobradorCopy);

            DataColumn dtColumnDateTimeCreationFordtCobradorCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "DateTimeCreation"
            };
            dtCobradorCopy.Columns.Add(dtColumnDateTimeCreationFordtCobradorCopy);

            DataColumn dtColumnDateTimeLastModificationFordtCobradorCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "DateTimeLastModification"
            };
            dtCobradorCopy.Columns.Add(dtColumnDateTimeLastModificationFordtCobradorCopy);

            DataColumn dtColumnUserCreationIdFordtCobradorCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "UserCreationId"
            };
            dtCobradorCopy.Columns.Add(dtColumnUserCreationIdFordtCobradorCopy);

            DataColumn dtColumnUserLastModificationIdFordtCobradorCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "UserLastModificationId"
            };
            dtCobradorCopy.Columns.Add(dtColumnUserLastModificationIdFordtCobradorCopy);

            DataColumn dtColumnNombreCompletoFordtCobradorCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "NombreCompleto"
            };
            dtCobradorCopy.Columns.Add(dtColumnNombreCompletoFordtCobradorCopy);

            DataColumn dtColumnCelularFordtCobradorCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "Celular"
            };
            dtCobradorCopy.Columns.Add(dtColumnCelularFordtCobradorCopy);

            DataColumn dtColumnDireccionFordtCobradorCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "Direccion"
            };
            dtCobradorCopy.Columns.Add(dtColumnDireccionFordtCobradorCopy);

            DataColumn dtColumnEmailFordtCobradorCopy = new()
            {
                DataType = typeof(string),
                ColumnName = "Email"
            };
            dtCobradorCopy.Columns.Add(dtColumnEmailFordtCobradorCopy);

            
            #endregion

            dtCobradorOriginal = dtCobrador;

            foreach (DataRow DataRow in dtCobradorOriginal.Rows)
            {
                dtCobradorCopy.Rows.Add(DataRow.ItemArray);
            }

            var Sheet = Book.Worksheets.Add(dtCobradorCopy);
        ...
        public void ExportToCSV(string path, List<Cobrador> lstCobrador)
        {
            using var Writer = new StreamWriter(path);

            using var CsvWriter = new CsvWriter(Writer, CultureInfo.InvariantCulture);

            CsvWriter.WriteRecords(lstCobrador);
        }

        public void ExportToPDF(string path, List<Cobrador> lstCobrador)
        {
            string ProjectName = "JuanApp2";
            string Table = "Cobrador";
            ...
            {
                RowsAsHTML += $@"{Cobrador?.ToStringOnlyValuesForHTML()}";
            }
    ...
    <tr>
        <th align=""left"" valign=""top"" style=""border-width: 1px; border-style: solid; border-color: #e8e8e8; border-top: none; border-left: none; border-right: none;"">
            <font face=""'Source Sans Pro', sans-serif"" color=""#000000"" style=""font-size: 20px; line-height: 28px; font-weight: 600;"">
                <span style=""font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 20px; line-height: 28px; font-weight: 600;"">CobradorId&nbsp;&nbsp;&nbsp;</span>
            </font>
            ...
            <font face=""'Source Sans Pro', sans-serif"" color=""#000000"" style=""font-size: 20px; line-height: 28px; font-weight: 600;"">
                <span style=""font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 20px; line-height: 28px; font-weight: 600;"">CobradorStatusId&nbsp;&nbsp;&nbsp;</span>
            </font>
            <div style=""height: 10px; line-height: 10px; font-size: 8px;"">&nbsp;</div>
        </th>
    </tr>
...
").SaveAs(path);
        ...
        #region Importations
        public List<Cobrador> ImportExcel(string path, int userId)
        {
            ...
            foreach (var row in Rows)
            {
                ...
                if (rowNumber > 1)
                {
                    string NombreCompleto = row.Cell(7).GetString();
                    string Celular = row.Cell(8).GetString();
                    string Direccion = row.Cell(9).GetString();
                    string Email = row.Cell(10).GetString();
