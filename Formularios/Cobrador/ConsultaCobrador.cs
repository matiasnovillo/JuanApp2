...
namespace JuanApp.Formularios.Entrada
{
    public partial class ConsultaCobrador : Form
    {
        ...
        public ConsultaCobrador(ServiceProvider serviceProvider)
        {
            try
            {
        ...
        private void DataGridViewEntrada_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (e.ColumnIndex == 4)
                {
                    ...
                    FormularioCobrador FormularioCobrador = new(_serviceProvider,
                    CobradorId);
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                FormularioCobrador FormularioCaja = new(_serviceProvider,
                        0);
